...
// Using let
let name = "Joshua"; // Define a string here, e.g., "Juan Cruz"
let age = 19; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["Running", "Basketball", "Coding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const birthYear = 2000; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["Story", "Romance"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = 25.00; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["Red", "Blue"]; // Define an array here, e.g., ["red", "green", "blue"]
